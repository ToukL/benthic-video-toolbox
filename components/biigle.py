...
class Api(object):
   def __init__(self, email = '', token = '', base_url = 'https://calcul01.epoc.u-bordeaux.fr:8443/api/v1', headers = {}):
      ...
      Kwargs:
         base_url (str): Base URL to use for the API URL. Default: `'https://calcul01.epoc.u-bordeaux.fr:8443/api/v1'`.
